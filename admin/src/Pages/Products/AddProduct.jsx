...
// /* ════════════════════════════════════════════════════════════════
//    D DOLLY LAMB — ADD PRODUCT  |  Light Luxury Theme
...
// const focusGreen = e => e.target.style.borderColor = B.greenBdr;
// const blurBorder = (err = false) => e => e.target.style.borderColor = err ? B.red.border : B.border;
...
//                 </button>
//                 <img src={URL.createObjectURL(imgs[cur])} alt="" style={{ maxWidth: '80vw', maxHeight: '70vh', borderRadius: 14, objectFit: 'contain', boxShadow: '0 20px 60px rgba(28,43,58,0.25)', border: `1px solid ${B.border}` }} />
//                 {cur > 0 && (
...
//     return (
//         <div style={{ position: 'fixed', inset: 0, zIndex: 50, background: 'rgba(28,43,58,0.5)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, overflowY: 'auto' }}>
//             <div style={{ ...cardStyle(), padding: 36, maxWidth: 460, width: '100%', textAlign: 'center', borderRadius: 20, boxShadow: '0 24px 60px rgba(28,43,58,0.2)' }}>
//                 <div style={{ width: 60, height: 60, borderRadius: 16, background: B.amber.bg, border: `1px solid ${B.amber.border}`, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 18px' }}>
//                     <TbDeviceFloppy size={28} style={{ color: B.amber.dot }} />
//                 </div>
//                 <h2 style={{ color: B.navy, fontSize: 22, fontWeight: 800, letterSpacing: -.5, marginBottom: 8, fontFamily: 'Georgia, serif' }}>Draft Saved!</h2>
//                 <p style={{ color: B.navySoft, fontSize: 13.5, marginBottom: 24, lineHeight: 1.6 }}>Your listing is saved. Complete remaining steps before publishing.</p>

//                 {/* Progress */}
//                 <div style={{ marginBottom: 20, textAlign: 'left' }}>
//                     <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12, fontWeight: 600, color: B.navyGhost, marginBottom: 8 }}>
//                         <span>Listing Progress</span>
//                         <span style={{ color: B.green }}>{doneCount}/{steps.length} · {pct}%</span>
//                     </div>
//                     <div style={{ height: 6, background: B.surface2, borderRadius: 4, overflow: 'hidden' }}>
//                         <div style={{ height: '100%', background: B.green, borderRadius: 4, width: `${pct}%`, transition: 'width .7s' }} />
//                     </div>
//                 </div>

//                 {/* Checklist */}
//                 <div style={{ background: B.surface, border: `1px solid ${B.border}`, borderRadius: 12, padding: 16, textAlign: 'left', marginBottom: 24 }}>
//                     <p style={{ color: B.navyGhost, fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.7px', marginBottom: 12 }}>Checklist</p>
//                     {steps.map((s, i) => (
//                         <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: i < steps.length - 1 ? `1px solid ${B.border}` : 'none' }}>
//                             <div style={{
//                                 width: 20, height: 20, borderRadius: '50%', flexShrink: 0,
//                                 display: 'flex', alignItems: 'center', justifyContent: 'center',
//                                 background: s.done ? B.emerald.dot : B.surface2,
//                                 border: `1px solid ${s.done ? B.emerald.dot : B.border}`,
//                             }}>
//                                 {s.done && <TbCheck size={11} style={{ color: '#FFFFFF' }} />}
//                             </div>
//                             <span style={{ flex: 1, fontSize: 12.5, fontWeight: 500, color: s.done ? B.navy : B.navySoft }}>{s.label}</span>
//                             <span style={{ fontSize: 11, fontWeight: 700, color: s.done ? B.emerald.text : B.navyGhost }}>{s.done ? '✓ Done' : s.detail}</span>
//                         </div>
//                     ))}
//                 </div>
...
//                 {/* Buttons */}
//                 <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
//                     <button onClick={onContinue} style={{ padding: '12px', borderRadius: 11, background: B.green, color: '#FFFFFF', border: 'none', fontSize: 13.5, fontWeight: 700, cursor: 'pointer', transition: 'background .15s' }}
//                         onMouseEnter={e => e.currentTarget.style.background = B.greenLight}
//                         onMouseLeave={e => e.currentTarget.style.background = B.green}>
//                         Continue Editing
//                     </button>
//                     {canPublish && (
//                         <button onClick={onPublishNow} style={{ padding: '12px', borderRadius: 11, background: B.emerald.bg, color: B.emerald.text, border: `1px solid ${B.emerald.border}`, fontSize: 13.5, fontWeight: 700, cursor: 'pointer' }}>
//                             🚀 Publish Now
//                         </button>
//                     )}
//                     <button onClick={onNewProduct} style={{ padding: '12px', borderRadius: 11, background: 'transparent', color: B.navySoft, border: `1px solid ${B.border}`, fontSize: 13.5, fontWeight: 600, cursor: 'pointer' }}>
//                         + Add Another Product
//                     </button>
//                 </div>
//                 <p style={{ color: B.navyGhost, fontSize: 11, marginTop: 14 }}>Saved at {new Date().toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit' })}</p>
//             </div>
//         </div>
//     );
// };
...
//             <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
//                 <div style={{ width: 36, height: 36, borderRadius: 10, background: B.greenBg, border: `1px solid ${B.greenBdr}`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: B.green, flexShrink: 0 }}>
//                     {icon}
//                 </div>
//                 <div>
//                     <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
...
// /* ── Step indicator ── */
// const Steps = ({ steps }) => (
//     <div style={{ background: B.surfaceCard, borderBottom: `1px solid ${B.border}`, padding: '0 24px', display: 'flex', alignItems: 'center', overflowX: 'auto', gap: 0 }}>
//         {steps.map(([num, label, done], i) => (
//             <React.Fragment key={num}>
//                 <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '13px 8px', flexShrink: 0, opacity: done ? 1 : .5 }}>
//                     <div style={{
//                         width: 22, height: 22, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center',
//                         fontSize: 10.5, fontWeight: 800, flexShrink: 0,
//                         background: done ? B.emerald.dot : B.surface2,
//                         color: done ? '#FFFFFF' : B.navyGhost,
//                         border: `1.5px solid ${done ? B.emerald.dot : B.border}`,
//                     }}>
//                         {done ? <TbCheck size={11} /> : num}
//                     </div>
//                     <span style={{ fontSize: 12, whiteSpace: 'nowrap', color: done ? B.navy : B.navySoft, fontWeight: done ? 700 : 500 }}>{label}</span>
//                 </div>
//                 {i < steps.length - 1 && <TbChevronRight size={12} style={{ color: B.navyGhost, flexShrink: 0, margin: '0 4px' }} />}
//             </React.Fragment>
//         ))}
//     </div>
// );
...
//             if (!uploaded.length) errs.push('At least one image is required');
...
//     const onSubmit = async (e) => {
//         e?.preventDefault();
//         const errs = validate(false); if (errs.length) { setValErrs(errs); window.scrollTo({ top: 0, behavior: 'smooth' }); return; }
//         setValErrs([]); setSubmitting(true);
//         try {
//             const fd = new FormData();
//             fd.append('name', name.trim()); fd.append('description', description.trim()); fd.append('detailedDescription', detailedDescription);
...
//                 .ap-quill .ql-toolbar { background:${B.surface}!important; border:1px solid ${B.border}!important; border-radius:10px 10px 0 0!important; }
//                 .ap-quill .ql-toolbar .ql-stroke { stroke:${B.navySoft}!important; }
//                 .ap-quill .ql-toolbar .ql-fill   { fill:${B.navySoft}!important; }
//                 .ap-quill .ql-toolbar button:hover .ql-stroke, .ap-quill .ql-toolbar button.ql-active .ql-stroke { stroke:${B.green}!important; }
//                 .ap-quill .ql-toolbar button:hover .ql-fill,   .ap-quill .ql-toolbar button.ql-active .ql-fill   { fill:${B.green}!important; }
//                 .ap-quill .ql-toolbar .ql-picker-label  { color:${B.navySoft}!important; }
//                 .ap-quill .ql-toolbar .ql-picker-options{ background:${B.surfaceCard}!important; border:1px solid ${B.border}!important; border-radius:8px!important; }
//                 .ap-quill .ql-container { background:${B.surfaceCard}!important; border:1px solid ${B.border}!important; border-top:none!important; border-radius:0 0 10px 10px!important; min-height:160px; }
//                 .ap-quill .ql-editor   { color:${B.navy}!important; font-family:inherit!important; font-size:13.5px!important; }
//                 .ap-quill .ql-editor.ql-blank::before { color:${B.navyGhost}!important; font-style:normal!important; }
//                 input[type=color]  { background:transparent; padding:2px; }
//                 input[type=number]::-webkit-inner-spin-button { opacity:.3; }
//             `}</style>
...
//                     </div>
//                     <div>
//                         <h1 style={{ color: B.navy, fontSize: 16, fontWeight: 800, letterSpacing: -.3, lineHeight: 1, margin: 0, fontFamily: 'Georgia, serif' }}>Add Product</h1>
//                         <p style={{ color: B.navyGhost, fontSize: 11, marginTop: 2, lineHeight: 1 }}>{progress}% complete</p>
//                     </div>
//                     {draftNotif && (
//                         <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '4px 10px', borderRadius: 99, background: B.greenBg, color: B.green, border: `1px solid ${B.greenBdr}`, fontSize: 11, fontWeight: 700 }}>
//                             <TbDeviceFloppy size={12} /> Auto-saved
//                         </span>
//                     )}
//                 </div>
...
//                         style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 14px', borderRadius: 9, background: B.surfaceCard, color: B.navyGhost, border: `1px solid ${B.border}`, fontSize: 12, fontWeight: 600, cursor: 'pointer', transition: 'all .15s' }}
...
//                         onMouseLeave={e => { e.currentTarget.style.color = B.navyGhost; e.currentTarget.style.borderColor = B.border; e.currentTarget.style.background = B.surfaceCard; }}>
//                         <TbTrash size={13} /> Clear
//                     </button>
//                     {/* Save Draft */}
//                     <button type="button" onClick={saveDraft} disabled={draftSaving}
//                         style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 14px', borderRadius: 9, background: B.amber.bg, color: B.amber.text, border: `1px solid ${B.amber.border}`, fontSize: 12, fontWeight: 700, cursor: 'pointer', opacity: draftSaving ? .6 : 1, transition: 'all .15s' }}>
//                         <TbDeviceFloppy size={13} /> {draftSaving ? 'Saving…' : 'Save Draft'}
//                     </button>
//                     {/* Publish */}
//                     <button type="button" onClick={onSubmit} disabled={submitting}
//                         style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 18px', borderRadius: 9, background: B.green, color: '#FFFFFF', border: 'none', fontSize: 12, fontWeight: 700, cursor: 'pointer', opacity: submitting ? .6 : 1, transition: 'background .15s' }}
//                         onMouseEnter={e => { if (!submitting) e.currentTarget.style.background = B.greenLight; }}
//                         onMouseLeave={e => e.currentTarget.style.background = B.green}>
//                         <TbRocket size={13} /> {submitting ? 'Publishing…' : 'Publish'}
//                     </button>
//                 </div>
//             </div>
...
//                 <div style={{ height: '100%', background: B.green, transition: 'width .5s', width: `${progress}%` }} />
//             </div>

//             <form onSubmit={onSubmit}>
//                 <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 16, padding: '18px 24px 40px', maxWidth: 1400, alignItems: 'start' }}>

//                     {/* ══════════════ MAIN COLUMN ══════════════ */}
//                     <div>
//                         {/* Validation errors */}
//                         {valErrs.length > 0 && (
//                             <div style={{ background: B.red.bg, border: `1px solid ${B.red.border}`, borderRadius: 12, padding: 16, marginBottom: 14 }}>
//                                 <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
//                                     <TbAlertTriangle size={15} style={{ color: B.red.text, flexShrink: 0 }} />
//                                     <h4 style={{ color: B.red.text, fontSize: 13, fontWeight: 700, margin: 0 }}>Please fix before continuing:</h4>
//                                 </div>
...
//                                 <div style={{ position: 'relative' }}>
//                                     <textarea
//                                         style={{ ...inputStyle(name.length > 220), resize: 'none', wordBreak: 'break-word', overflowWrap: 'break-word', overflow: 'hidden', minHeight: 48, lineHeight: '1.5' }}
//                                         maxLength={250} rows={2}
//                                         placeholder="e.g. Classic Lambskin Leather Jacket"
//                                         value={name} onChange={e => setName(e.target.value)}
//                                         onFocus={focusGreen} onBlur={blurBorder(name.length > 220)}
//                                     />
...
//                                 <div style={{ position: 'relative' }}>
//                                     <textarea
//                                         style={{ ...inputStyle(description.length > 280), resize: 'vertical', minHeight: 88 }}
//                                         maxLength={300} placeholder="Compelling product description…"
//                                         value={description} onChange={e => setDesc(e.target.value)}
//                                         onFocus={focusGreen} onBlur={blurBorder(description.length > 280)}
//                                     />
...
//                                         {['Men', 'Women', 'Others', 'Leather Pillow Cover', 'Sofa Headrest', 'Leather Desk Pad', 'Men Leather Apron'].map(c => <option key={c} value={c}>{c}</option>)}
//                                     </select>
//                                 </Field>
//                                 <Field label="Sub Category">
//                                     <select style={selectStyle} value={subCategory} onChange={e => setSubCat(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()}>
//                                         {category === 'Men' && <><option value="Jackets">Jackets</option><option value="Bomber Biker Jacket">Bomber Biker Jacket</option><option value="Moto Biker Jacket">Moto Biker Jacket</option><option value="Racing Coat">Racing Coat</option><option value="Leather Coats">Leather Coats</option><option value="Men Winter Wear">Men Winter Wear</option></>}
//                                         {category === 'Women' && <><option value="Jackets">Jackets</option><option value="Bomber Biker Jacket">Bomber Biker Jacket</option><option value="Moto Biker Jacket">Moto Biker Jacket</option><option value="Racing Coat">Racing Coat</option><option value="Women Winter Wear">Women Winter Wear</option><option value="Women Night Dress">Women Night Dress</option><option value="Leather Pencil Skirt">Leather Pencil Skirt</option><option value="Leather Full Skirt">Leather Full Skirt</option><option value="Slim Bodycon Skirt">Slim Bodycon Skirt</option></>}
//                                         {category === 'Others' && <><option value="Pillow">Pillow</option><option value="Cushion Cover">Cushion Cover</option><option value="Aprons">Aprons</option><option value="Desk Mat">Desk Mat</option><option value="Chair Cover">Chair Cover</option></>}
//                                         {category === 'Leather Pillow Cover' && <><option value="Cylindrical Pillow Cover">Cylindrical Pillow Cover</option><option value="Square Pillow Cover">Square Pillow Cover</option><option value="Rectangle Pillow Cover">Rectangle Pillow Cover</option><option value="Round Pillow Cover">Round Pillow Cover</option><option value="Ear Hole Pillow Cushion Cover">Ear Hole Pillow Cushion Cover</option></>}
//                                         {category === 'Sofa Headrest' && <option value="Recliner Chair Headrest Cover">Recliner Chair Headrest Cover</option>}
//                                         {category === 'Leather Desk Pad' && <option value="Leather Desk Mat">Leather Desk Mat</option>}
//                                         {category === 'Men Leather Apron' && <option value="Apron">Apron</option>}
//                                     </select>
...
//                                     <TbPhoto size={20} style={{ color: dragging ? B.green : B.navyGhost }} />
//                                 </div>
//                                 <p style={{ color: B.navy, fontSize: 14, fontWeight: 600, marginBottom: 4 }}>{dragging ? 'Drop your images here!' : 'Drag & drop images here'}</p>
//                                 <p style={{ color: B.navySoft, fontSize: 12 }}>or click to upload · PNG, JPG, WEBP · 800×800px recommended</p>
//                                 {!dragging && <input type="file" accept="image/*" multiple style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', opacity: 0, cursor: 'pointer', fontSize: 0 }}
//                                     onChange={e => { const files = Array.from(e.target.files); let added = 0; setImages(prev => { const next = [...prev]; files.forEach(f => { const s = next.findIndex(x => !x); if (s !== -1) { next[s] = f; added++; } }); return next; }); e.target.value = ''; requestAnimationFrame(() => { if (added) toast.success(`${added} image${added > 1 ? 's' : ''} added!`); else toast.info('All slots full'); }); }} />}
//                             </div>
...
//                                         border: `2px solid ${img ? (i === 0 ? B.green : B.border) : B.border}`,
//                                         background: img ? 'transparent' : B.surface, cursor: img ? 'default' : 'pointer',
//                                         boxShadow: i === 0 && img ? `0 0 0 2px ${B.greenBg}` : undefined,
//                                     }}>
//                                         {img ? (
//                                             <>
//                                                 <img src={URL.createObjectURL(img)} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
//                                                 {i === 0 && <span style={{ position: 'absolute', top: 5, left: 5, background: B.green, color: '#FFFFFF', fontSize: 8, fontWeight: 800, padding: '2px 6px', borderRadius: 5 }}>MAIN</span>}
//                                                 <span style={{ position: 'absolute', top: 5, right: 5, background: 'rgba(28,43,58,0.65)', color: '#fff', fontSize: 8, fontWeight: 700, padding: '2px 6px', borderRadius: 5 }}>{i + 1}</span>
//                                                 <div style={{ position: 'absolute', inset: 0, background: 'rgba(28,43,58,0.60)', opacity: 0, transition: 'opacity .18s', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 6 }}
//                                                     onMouseEnter={e => e.currentTarget.style.opacity = '1'}
//                                                     onMouseLeave={e => e.currentTarget.style.opacity = '0'}>
//                                                     <button type="button" style={{ background: B.green, color: '#fff', fontSize: 10, fontWeight: 700, padding: '4px 10px', borderRadius: 7, border: 'none', cursor: 'pointer' }} onMouseDown={e => { e.preventDefault(); e.stopPropagation(); setLbIdx(uploaded.indexOf(img)); setLbOpen(true); }}>🔍 View</button>
//                                                     <button type="button" style={{ background: B.red.bg, color: B.red.text, fontSize: 10, fontWeight: 700, padding: '4px 10px', borderRadius: 7, border: `1px solid ${B.red.border}`, cursor: 'pointer' }} onMouseDown={e => { e.preventDefault(); e.stopPropagation(); delImg(i); }}>✕ Remove</button>
//                                                 </div>
//                                             </>
//                                         ) : (
...
//                                 ))}
//                             </div>
//                             <p style={{ color: B.navyGhost, fontSize: 11.5, marginTop: 10 }}>First slot = main thumbnail. Hover any image to view or remove.</p>
//                         </Card>
...
//                                 {(colorMode === 'both' || colorMode === 'nameOnly') && (
//                                     <Field label="Name">
//                                         <input style={{ ...inputStyle(), width: 160 }} type="text" placeholder="e.g. Navy Blue" value={newColorName} onChange={e => setNewCName(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()} onKeyDown={e => e.key === 'Enter' && (e.preventDefault(), addColor())} />
//                                     </Field>
//                                 )}
//                                 {(colorMode === 'both' || colorMode === 'hexOnly') && (
//                                     <Field label="Color">
//                                         <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
//                                             <input type="color" value={newColorHex} onChange={e => setNewCHex(e.target.value)} style={{ width: 40, height: 40, borderRadius: 9, border: `1px solid ${B.border}`, cursor: 'pointer', background: 'transparent' }} />
//                                             <input style={{ ...inputStyle(), width: 100 }} type="text" value={newColorHex} onChange={e => setNewCHex(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()} />
//                                         </div>
//                                     </Field>
//                                 )}
//                                 <button type="button" onClick={addColor} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 18px', borderRadius: 10, background: B.green, color: '#FFFFFF', border: 'none', fontSize: 13, fontWeight: 700, cursor: 'pointer', transition: 'background .15s' }}
//                                     onMouseEnter={e => e.currentTarget.style.background = B.greenLight}
//                                     onMouseLeave={e => e.currentTarget.style.background = B.green}>
//                                     <TbPlus size={14} /> Add
//                                 </button>
...
//                                     <TbPalette size={28} style={{ color: B.navyGhost, margin: '0 auto 8px', display: 'block' }} />
//                                     <p style={{ color: B.navySoft, fontSize: 13, fontWeight: 500 }}>No colors yet</p>
//                                     <p style={{ color: B.navyGhost, fontSize: 12 }}>Add above or pick from presets below</p>
//                                 </div>
//                             ) : (
//                                 <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 14 }}>
//                                     {colors.map((c, i) => (
...
//                                             </div>
//                                             <div style={{ width: 22, height: 22, borderRadius: '50%', flexShrink: 0, background: c.hex, border: `1px solid ${B.border}` }} />
//                                             <button type="button" onClick={() => rmColor(c.name)} style={{ width: 28, height: 28, borderRadius: 8, background: B.red.bg, border: `1px solid ${B.red.border}`, color: B.red.text, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}>
//                                                 <TbX size={12} />
//                                             </button>
//                                         </div>
...
//                             {sizeErr && (
//                                 <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 14px', background: B.red.bg, border: `1px solid ${B.red.border}`, borderRadius: 10, marginBottom: 14 }}>
//                                     <TbAlertTriangle size={15} style={{ color: B.red.text, flexShrink: 0 }} />
//                                     <span style={{ color: B.red.text, fontSize: 12.5, fontWeight: 600 }}>Please select at least one size — required before saving or publishing.</span>
//                                 </div>
//                             )}
...
//                             <Field label="Base Price (₹)" required>
//                                 <input style={inputStyle(price && (isNaN(+price) || +price <= 0))} type="number" placeholder="e.g. 4999" min="0" step="0.01" value={price} onChange={e => setPrice(e.target.value)} onFocus={focusGreen} onBlur={blurBorder(price && (isNaN(+price) || +price <= 0))} />
...
//                                             return (
//                                                 <div key={k} style={{
//                                                     borderRadius: 11, padding: 14, cursor: 'pointer', transition: 'all .18s',
//                                                     border: `2px solid ${on ? B.green : B.border}`,
//                                                     background: on ? B.greenBg : B.surfaceCard,
//                                                 }} onClick={() => !on && toggleSize(k)}>
//                                                     <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: on ? 10 : 0 }}>
//                                                         <input type="checkbox" checked={on} onChange={() => toggleSize(k)} onClick={e => e.stopPropagation()} style={{ width: 14, height: 14, accentColor: B.green, cursor: 'pointer' }} />
...
//                                                                     <input type="number" step="0.05" min="0.5" max="3" value={d.multiplier} onChange={e => setSzF(k, 'multiplier', e.target.value)} style={{ ...inputStyle(), padding: '6px 10px', fontSize: 12 }} onFocus={focusGreen} onBlur={blurBorder()} />
//                                                                     <span style={{ color: B.emerald.text, fontSize: 10.5, fontWeight: 700, marginTop: 3, display: 'block' }}>₹ {price ? calcP(d).toFixed(2) : '—'}</span>
//                                                                 </div>
//                                                             )}
//                                                             <div>
//                                                                 <p style={{ fontSize: 10, color: B.navyGhost, fontWeight: 600, textTransform: 'uppercase', marginBottom: 4 }}>Stock</p>
//                                                                 <input type="number" min="0" value={d.stock} onChange={e => setSzF(k, 'stock', e.target.value)} style={{ ...inputStyle(), padding: '6px 10px', fontSize: 12 }} onFocus={focusGreen} onBlur={blurBorder()} />
//                                                             </div>
//                                                         </div>
//                                                     )}
//                                                 </div>
...
//                                         ['All Sizes', () => { setEnabled(Object.keys(stdSizes)); setSizeErr(false); toast.success('All selected!'); }],
//                                         ['Clear', () => setEnabled([])]].map(([lbl, action]) => (
//                                             <button key={lbl} type="button" onClick={action} style={{ padding: '7px 14px', borderRadius: 9, border: `1px solid ${B.border}`, background: B.surfaceCard, color: B.navySoft, fontSize: 12, fontWeight: 600, cursor: 'pointer', transition: 'all .15s' }}
...
//                                         }
//                                         <button type="button" onClick={addInch} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 18px', borderRadius: 10, background: B.green, color: '#FFFFFF', border: 'none', fontSize: 13, fontWeight: 700, cursor: 'pointer', transition: 'background .15s' }}
//                                             onMouseEnter={e => e.currentTarget.style.background = B.greenLight}
//                                             onMouseLeave={e => e.currentTarget.style.background = B.green}>
//                                             <TbPlus size={14} /> Add Size
//                                         </button>
...
//                                             <TbRuler size={28} style={{ color: B.navyGhost, margin: '0 auto 8px', display: 'block' }} />
//                                             <p style={{ color: B.navySoft, fontSize: 13 }}>No inch sizes yet — add above</p>
//                                         </div>
//                                     ) : (
//                                         <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10 }}>
//                                             {inchSizes.map((s, i) => (
...
//                                                     </label>
//                                                     {s.useCustomPrice
//                                                         ? <div style={{ marginBottom: 8 }}><p style={{ fontSize: 10, color: B.navyGhost, fontWeight: 600, textTransform: 'uppercase', marginBottom: 4 }}>Price (₹)</p><input type="number" step="0.01" min="0" value={s.customPrice} onChange={e => edInch(i, 'customPrice', e.target.value)} style={{ ...inputStyle(), padding: '6px 10px', fontSize: 12 }} onFocus={focusGreen} onBlur={blurBorder()} /></div>
//                                                         : <div style={{ marginBottom: 8 }}><p style={{ fontSize: 10, color: B.navyGhost, fontWeight: 600, textTransform: 'uppercase', marginBottom: 4 }}>Multiplier</p><input type="number" step="0.1" min="0.5" max="2" value={s.multiplier} onChange={e => edInch(i, 'multiplier', e.target.value)} style={{ ...inputStyle(), padding: '6px 10px', fontSize: 12 }} onFocus={focusGreen} onBlur={blurBorder()} /></div>
//                                                     }
//                                                     <div><p style={{ fontSize: 10, color: B.navyGhost, fontWeight: 600, textTransform: 'uppercase', marginBottom: 4 }}>Stock</p><input type="number" min="0" value={s.stock} onChange={e => edInch(i, 'stock', e.target.value)} style={{ ...inputStyle(), padding: '6px 10px', fontSize: 12 }} onFocus={focusGreen} onBlur={blurBorder()} /></div>
//                                                     <span style={{ color: B.emerald.text, fontSize: 10.5, fontWeight: 700, marginTop: 5, display: 'block' }}>₹ {price && +price > 0 ? ((+price) * s.multiplier).toFixed(2) : '—'}</span>
//                                                 </div>
//                                             ))}
//                                         </div>
...
//                                 </div>
//                                 <div>
//                                     <p style={{ color: B.navy, fontSize: 13, fontWeight: 700, margin: 0 }}>Save & Publish</p>
//                                     <p style={{ color: B.navyGhost, fontSize: 11, marginTop: 2 }}>Draft saves · Publish goes live</p>
//                                 </div>
//                             </div>
//                             {/* Progress */}
//                             <div style={{ marginBottom: 16 }}>
...
//                                     <span style={{ color: B.green }}>{progress}%</span>
//                                 </div>
...
//                                 </div>
//                                 <div style={{ width: 34, height: 18, borderRadius: 99, position: 'relative', transition: 'background .18s', background: bestseller ? B.green : B.surface2, border: `1px solid ${bestseller ? B.green : B.border}` }}>
...
//                                 </div>
//                             </button>
//                             <button type="button" onClick={saveDraft} disabled={draftSaving} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, padding: '10px', borderRadius: 10, marginBottom: 8, cursor: 'pointer', transition: 'all .15s', background: B.amber.bg, color: B.amber.text, border: `1px solid ${B.amber.border}`, fontSize: 13, fontWeight: 700, opacity: draftSaving ? .6 : 1 }}>
//                                 <TbDeviceFloppy size={14} /> {draftSaving ? 'Saving…' : 'Save as Draft'}
//                             </button>
//                             <button type="submit" disabled={submitting} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, padding: '10px', borderRadius: 10, cursor: 'pointer', background: B.green, color: '#FFFFFF', border: 'none', fontSize: 13, fontWeight: 700, opacity: submitting ? .6 : 1, transition: 'background .15s' }}
//                                 onMouseEnter={e => { if (!submitting) e.currentTarget.style.background = B.greenLight; }}
//                                 onMouseLeave={e => e.currentTarget.style.background = B.green}>
//                                 <TbRocket size={14} /> {submitting ? 'Publishing…' : 'Publish Now'}
//                             </button>
//                         </div>
...
//                                 </div>
//                                 <p style={{ color: B.navy, fontSize: 13, fontWeight: 700, margin: 0 }}>Pricing</p>
//                             </div>
//                             <Field label="Sale / Discount Price (₹)" hint="Optional — shown as sale price">
//                                 <input style={inputStyle()} type="number" placeholder="0.00" value={discountPrice} onChange={e => setDiscPrice(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()} />
//                             </Field>
//                             {discount && (
...
//                                 </div>
//                                 <p style={{ color: B.navy, fontSize: 13, fontWeight: 700, margin: 0 }}>Live Summary</p>
//                             </div>
//                             {[
...
//                                 ['Sale Price', discountPrice ? <span style={{ color: B.emerald.text, fontWeight: 800 }}>₹{discountPrice}</span> : <span style={{ color: B.navyGhost }}>—</span>],
...
//                                 ['Sizes', sizeType === 'standard'
//                                     ? (enabledSizes.length ? <span style={{ fontWeight: 700, color: B.navy }}>{enabledSizes.join(', ')}</span> : <span style={{ color: B.red.text, fontWeight: 700, fontSize: 11 }}>⚠ Required</span>)
...
//                                 <p style={{ color: B.navy, fontSize: 13, fontWeight: 700, margin: 0 }}>Admin Tips</p>
//                             </div>
//                             <ul style={{ paddingLeft: 0, margin: 0, listStyle: 'none' }}>
//                                 {[
//                                     'Drag & drop multiple images onto the drop zone',
//                                     'Base price × multiplier = size\'s selling price',
//                                     'Enable "Custom Price" per size for fixed pricing',
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 50, background: 'rgba(28,43,58,0.5)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, overflowY: 'auto' }}>
            <div style={{ ...cardStyle(), padding: 36, maxWidth: 460, width: '100%', textAlign: 'center', borderRadius: 20, boxShadow: '0 24px 60px rgba(28,43,58,0.2)' }}>
                ...
                <div style={{ background: B.surface, border: `1px solid ${B.border}`, borderRadius: 12, padding: 16, textAlign: 'left', marginBottom: 24 }}>
                    ...
                    {steps.map((s, i) => (
                        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: i < steps.length - 1 ? `1px solid ${B.border}` : 'none' }}>
                            <div style={{ width: 20, height: 20, borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: s.done ? B.emerald.dot : B.surface2, border: `1px solid ${s.done ? B.emerald.dot : B.border}` }}>
                                {s.done && <TbCheck size={11} style={{ color: '#FFFFFF' }} />}
                            </div>
                            <span style={{ flex: 1, fontSize: 12.5, fontWeight: 500, color: s.done ? B.navy : B.navySoft }}>{s.label}</span>
                            <span style={{ fontSize: 11, fontWeight: 700, color: s.done ? B.emerald.text : B.navyGhost }}>{s.done ? '✓ Done' : s.detail}</span>
...
const Steps = ({ steps }) => (
    <div style={{ background: B.surfaceCard, borderBottom: `1px solid ${B.border}`, padding: '0 24px', display: 'flex', alignItems: 'center', overflowX: 'auto', gap: 0 }}>
        {steps.map(([num, label, done], i) => (
            <React.Fragment key={num}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '13px 8px', flexShrink: 0, opacity: done ? 1 : .5 }}>
                    <div style={{ width: 22, height: 22, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10.5, fontWeight: 800, flexShrink: 0, background: done ? B.emerald.dot : B.surface2, color: done ? '#FFFFFF' : B.navyGhost, border: `1.5px solid ${done ? B.emerald.dot : B.border}` }}>
                        {done ? <TbCheck size={11} /> : num}
                    </div>
                    <span style={{ fontSize: 12, whiteSpace: 'nowrap', color: done ? B.navy : B.navySoft, fontWeight: done ? 700 : 500 }}>{label}</span>
                </div>
    ...
    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
        {options.map(([v, l]) => (
            <button key={v} type="button" onClick={() => onChange(v)} style={{
                ...
                background: value === v ? B.green : B.surfaceCard,
                color: value === v ? '#FFFFFF' : B.navySoft,
                cursor: 'pointer', transition: 'all .15s', letterSpacing: '0.02em',
            }}>{l}</button>
        ))}
    </div>
);
...
const Add = ({ token }) => {
    ...
    /* ── Auto-set base price from smallest size custom price ── */
    useEffect(() => {
        let minP = null;
        if (sizeType === 'standard' && enabledSizes.length > 0) {
            const ORDER = ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'];
            ...
            if (d.useCustomPrice && d.customPrice) minP = parseFloat(d.customPrice);
        } else if (sizeType === 'inch' && inchSizes.length > 0) {
    ...
    const addInch = () => {
        ...
        setInchSizes([...inchSizes, {
            ...
            stock: niStock,
            customPrice: niPrice,
            useCustomPrice: pricingMode === "custom",   // ← driven by global mode
        }]);
            ...
            <form onSubmit={onSubmit}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 16, padding: '18px 24px 40px', maxWidth: 1400, alignItems: 'start' }}>
                    ...
                    <div>
                        ...
                        <Card icon={<TbPackage size={17} />} title="Basic Information" subtitle="Name, description & category">
                            <Field label="Product Name" required>
                                <div style={{ position: 'relative' }}>
                                    <textarea
                                        style={{ ...inputStyle(name.length > 220), resize: 'none', wordBreak: 'break-word', overflowWrap: 'break-word', overflow: 'hidden', minHeight: 48, lineHeight: '1.5' }}
                                        maxLength={250} rows={2} placeholder="e.g. Classic Lambskin Leather Jacket"
                                        value={name} onChange={e => setName(e.target.value)}
                                        onFocus={focusGreen} onBlur={blurBorder(name.length > 220)}
                                    />
                                    <span style={{ position: 'absolute', right: 12, bottom: 11, fontSize: 10.5, color: name.length > 220 ? B.amber.text : B.navyGhost, pointerEvents: 'none' }}>{name.length}/250</span>
                        ...
                        {/* ── ITEM DETAILS ── */}
                        <Card icon={<TbInfoCircle size={17} />} title="Item Details" subtitle="Additional product specifications">
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                                {itemDetails.map((item, index) => (
                                    <div key={index} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr auto', gap: 10, alignItems: 'center' }}>
                                        <input type="text" placeholder="Title (e.g. Brand Name)" value={item.title}
                                            ...
                                            style={inputStyle()} onFocus={focusGreen} onBlur={blurBorder()} />
                                        <input type="text" placeholder="Value (e.g. D Dolly Lamb)" value={item.value}
                                            onChange={e => updateItemDetail(index, 'value', e.target.value)}
                                            style={inputStyle()} onFocus={focusGreen} onBlur={blurBorder()} />
                                        <button type="button" onClick={() => removeItemDetail(index)}
                                            style={{ width: 38, height: 38, borderRadius: 10, border: `1px solid ${B.red.border}`, background: B.red.bg, color: B.red.text, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <TbTrash size={16} />
                                        </button>
                                    </div>
                                ))}
                                <button type="button" onClick={addItemDetail}
                                    style={{ padding: '12px', borderRadius: 10, border: `1px dashed ${B.greenBdr}`, background: B.greenBg, color: B.green, fontWeight: 700, cursor: 'pointer', fontSize: 13 }}>
                                    + Add Item Detail
                                </button>
                            </div>
                        </Card>
                        ...
                        <Card icon={<TbPhoto size={17} />} title="Product Images" subtitle={`${uploaded.length}/10 uploaded`}
                            ...
                            <div ref={dzRef} style={{ position: 'relative', borderRadius: 12, border: `2px dashed ${dragging ? B.green : B.borderStrong}`, textAlign: 'center', padding: '28px 20px', marginBottom: 14, background: dragging ? B.greenBg : B.surface, cursor: 'pointer', transition: 'all .2s', transform: dragging ? 'scale(1.01)' : 'none' }}
                                onDragEnter={handleDragEnter} onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
                                <div style={{ width: 44, height: 44, borderRadius: 12, margin: '0 auto 10px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: dragging ? B.greenBg : B.surfaceCard, border: `1px solid ${dragging ? B.greenBdr : B.border}` }}>
                                    <TbPhoto size={20} style={{ color: dragging ? B.green : B.navyGhost }} />
                                </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 10 }}>
                                {images.map((img, i) => (
                                    <div key={i} style={{ position: 'relative', aspectRatio: '1', borderRadius: 11, overflow: 'hidden', border: `2px solid ${img ? (i === 0 ? B.green : B.border) : B.border}`, background: img ? 'transparent' : B.surface, cursor: img ? 'default' : 'pointer', boxShadow: i === 0 && img ? `0 0 0 2px ${B.greenBg}` : undefined }}>
                                        {img ? (
                                            <>
                                                <img src={URL.createObjectURL(img)} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                                {i === 0 && <span style={{ position: 'absolute', top: 5, left: 5, background: B.green, color: '#FFFFFF', fontSize: 8, fontWeight: 800, padding: '2px 6px', borderRadius: 5 }}>MAIN</span>}
                        ...
                        <Card icon={<TbPalette size={17} />} title="Color Variants" subtitle="Add available colors"
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', gap: 12, padding: 16, background: B.surface, borderRadius: 11, border: `1px solid ${B.border}`, marginBottom: 14 }}>
                                <Field label="Name">
                                    <input style={{ ...inputStyle(), width: 160 }} type="text" placeholder="e.g. Navy Blue" value={newColorName}
                                        onChange={e => setNewCName(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()}
                            ...
                            <div style={{ borderTop: `1px solid ${B.border}`, paddingTop: 14 }}>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 7 }}>
                                    {PRESETS.map((p, i) => {
                                        const added = colors.some(c => c.name.toLowerCase() === p.name.toLowerCase());
                                        return (
                                            <button key={i} type="button" onClick={() => addPreset(p)} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '5px 12px', borderRadius: 99, fontSize: 12, fontWeight: 600, cursor: 'pointer', transition: 'all .15s', background: added ? B.emerald.bg : B.surfaceCard, color: added ? B.emerald.text : B.navySoft, border: `1px solid ${added ? B.emerald.border : B.border}` }}>
                                                <div style={{ width: 10, height: 10, borderRadius: '50%', background: p.hex, flexShrink: 0, border: `1px solid ${B.border}` }} />
                                                {p.name}{added ? ' ✓' : ''}
                                            </button>
                                        );
                        ...
                        <Card icon={<TbRuler size={17} />} title="Sizes & Inventory" subtitle="Minimum 1 size required"
                            ...
                            <Field label="Base Price (₹)" required>
                                <input style={inputStyle(price && (isNaN(+price) || +price <= 0))} type="number" placeholder="e.g. 4999" min="0" step="0.01"
                                    value={price} onChange={e => setPrice(e.target.value)} onFocus={focusGreen} onBlur={blurBorder(price && (isNaN(+price) || +price <= 0))} />
                                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginTop: 8, padding: 10, background: B.blue.bg, border: `1px solid ${B.blue.border}`, borderRadius: 9 }}>
                                    <TbInfoCircle size={13} style={{ color: B.blue.text, flexShrink: 0, marginTop: 1 }} />
                                    <span style={{ color: B.blue.text, fontSize: 12 }}>Base price × multiplier = size's selling price. XL at 1.2× = ₹{price ? (parseFloat(price) * 1.2).toFixed(2) : '—'}. Use Custom Price mode for fixed per-size pricing.</span>
                                </div>
                            </Field>
                            ...
                            {/* ── GLOBAL PRICING MODE ── */}
                            <div style={{ marginBottom: 20, padding: 16, border: `1px solid ${B.border}`, borderRadius: 12, background: B.surface }}>
                                <p style={{ fontSize: 12, fontWeight: 700, marginBottom: 10, color: B.navy, textTransform: 'uppercase', letterSpacing: '.5px' }}>
                                    Global Pricing Mode
                                </p>
                                <div style={{ display: 'flex', gap: 10 }}>
                                    {/* MULTIPLIER */}
                                    <button type="button"
                                        onClick={() => {
                                            setPricingMode("multiplier");
                                            // Standard sizes
                                            const updStd = { ...stdSizes };
                                            Object.keys(updStd).forEach(k => { updStd[k].useCustomPrice = false; });
                                            setStdSizes(updStd);
                                            // Inch sizes
                                            setInchSizes(prev => prev.map(s => ({ ...s, useCustomPrice: false })));
                                        }}
                                        style={{ padding: '10px 18px', borderRadius: 10, fontWeight: 700, cursor: 'pointer', transition: '.2s', border: `1px solid ${pricingMode === "multiplier" ? B.green : B.border}`, background: pricingMode === "multiplier" ? B.green : B.surfaceCard, color: pricingMode === "multiplier" ? '#fff' : B.navy }}>
                                        Multiplier Based
                                    </button>
                                    {/* CUSTOM PRICE */}
                                    <button type="button"
                                        onClick={() => {
                                            ...
                                            // Standard sizes
                                            const updStd = { ...stdSizes };
                                            Object.keys(updStd).forEach(k => { updStd[k].useCustomPrice = true; });
                                            setStdSizes(updStd);
                                            // Inch sizes
                                            setInchSizes(prev => prev.map(s => ({ ...s, useCustomPrice: true })));
                                        }}
                                        style={{ padding: '10px 18px', borderRadius: 10, fontWeight: 700, cursor: 'pointer', transition: '.2s', border: `1px solid ${pricingMode === "custom" ? B.green : B.border}`, background: pricingMode === "custom" ? B.green : B.surfaceCard, color: pricingMode === "custom" ? '#fff' : B.navy }}>
                                        Custom Price
                                    </button>
                                </div>
                                <p style={{ marginTop: 10, fontSize: 12, color: B.navyGhost }}>Select once and apply to all sizes automatically.</p>
                            </div>
                                ...
                                <>
                                    <div ref={sizeRef} className={sizeCardShake ? 'ap-shake' : ''} style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: 14 }}>
                                        {Object.keys(stdSizes).map(k => {
                                            ...
                                            const d = stdSizes[k];
                                            return (
                                                <div key={k} style={{ borderRadius: 11, padding: 14, cursor: 'pointer', transition: 'all .18s', border: `2px solid ${on ? B.green : B.border}`, background: on ? B.greenBg : B.surfaceCard }}
                                                    onClick={() => !on && toggleSize(k)}>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: on ? 10 : 0 }}>
                                                        <input type="checkbox" checked={on} onChange={() => toggleSize(k)} onClick={e => e.stopPropagation()} style={{ width: 14, height: 14, accentColor: B.green, cursor: 'pointer' }} />
                                                        <span style={{ fontSize: 13, fontWeight: 800, padding: '2px 7px', borderRadius: 6, background: on ? B.green : B.surface2, color: on ? '#FFFFFF' : B.navySoft }}>{k}</span>
                            ...
                            {sizeType === 'inch' && (
                                <>
                                    {/* ── Add form — NO Custom Price checkbox, global mode controls it ── */}
                                    <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', gap: 12, padding: 16, background: B.surface, borderRadius: 11, border: `1px solid ${B.border}`, marginBottom: 14 }}>
                                        <Field label="Size Label">
                                            <input style={{ ...inputStyle(), width: 100 }} type="text" placeholder="14x14" value={niSize} onChange={e => setNiSize(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()} />
                                        </Field>
                                        <Field label="Stock">
                                            <input style={{ ...inputStyle(), width: 80 }} type="number" min="0" value={niStock} onChange={e => setNiStock(parseInt(e.target.value) || 0)} onFocus={focusGreen} onBlur={blurBorder()} />
                                        </Field>
                                        {/* Show Price OR Multiplier input based on global mode — NO checkbox */}
                                        {pricingMode === "custom" ? (
                                            <Field label="Price (₹)">
                                                <input style={{ ...inputStyle(), width: 90 }} type="number" step="0.01" min="0" value={niPrice} onChange={e => setNiPrice(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()} />
                                            </Field>
                                        ) : (
                                            <Field label="Multiplier">
                                                <input style={{ ...inputStyle(), width: 85 }} type="number" step="0.1" min="0.5" max="2" value={niMult} onChange={e => setNiMult(parseFloat(e.target.value) || 1)} onFocus={focusGreen} onBlur={blurBorder()} />
                                            </Field>
                                        )}
                                        ...
                                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 10 }}>
                                            {inchSizes.map((s, i) => (
                                                <div key={i} style={{ background: B.surfaceCard, border: `1px solid ${B.border}`, borderRadius: 11, padding: 14 }}>
                                                    ...
                                                    {/* Card also driven by pricingMode — NO checkbox ── */}
                                                    {pricingMode === "custom" ? (
                                                        <div style={{ marginBottom: 8 }}>
                                                            ...
                                                            <input type="number" step="0.01" min="0" value={s.customPrice}
                                                                ...
                                                                onFocus={focusGreen} onBlur={blurBorder()} />
                                                            <span style={{ color: B.green, fontSize: 10.5, fontWeight: 700, marginTop: 3, display: 'block' }}>₹ {s.customPrice || '—'}</span>
                                                        </div>
                                                    ) : (
                                                        <div style={{ marginBottom: 8 }}>
                                                            <p style={{ fontSize: 10, color: B.navyGhost, fontWeight: 600, textTransform: 'uppercase', marginBottom: 4 }}>Multiplier</p>
                                                            <input type="number" step="0.1" min="0.5" max="2" value={s.multiplier}
                                                                onChange={e => edInch(i, 'multiplier', e.target.value)}
                                                                style={{ ...inputStyle(), padding: '6px 10px', fontSize: 12 }}
                                                                onFocus={focusGreen} onBlur={blurBorder()} />
                                                            <span style={{ color: B.emerald.text, fontSize: 10.5, fontWeight: 700, marginTop: 3, display: 'block' }}>₹ {price && +price > 0 ? ((+price) * s.multiplier).toFixed(2) : '—'}</span>
                                                        </div>
                                                    )}
                                                    <div>
                                                        <p style={{ fontSize: 10, color: B.navyGhost, fontWeight: 600, textTransform: 'uppercase', marginBottom: 4 }}>Stock</p>
                                                        <input type="number" min="0" value={s.stock} onChange={e => edInch(i, 'stock', e.target.value)} style={{ ...inputStyle(), padding: '6px 10px', fontSize: 12 }} onFocus={focusGreen} onBlur={blurBorder()} />
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        <div style={{ ...cardStyle({ marginBottom: 0 }), padding: 18 }}>
                            ...
                            <button type="button" onClick={() => setBestseller(p => !p)} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', borderRadius: 10, marginBottom: 12, cursor: 'pointer', transition: 'all .18s', border: `1px solid ${bestseller ? B.greenBdr : B.border}`, background: bestseller ? B.greenBg : 'transparent' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                    <TbStar size={15} style={{ color: bestseller ? B.green : B.navyGhost }} />
                                    <span style={{ color: bestseller ? B.navy : B.navySoft, fontSize: 13, fontWeight: 600 }}>Mark as Bestseller</span>
                                </div>
