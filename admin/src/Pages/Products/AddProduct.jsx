                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        <div style={{ ...cardStyle({ marginBottom: 0 }), padding: 18 }}>
                            ...
                            <Field label="Discount (%)" hint="Optional — percentage off, e.g. 10 = 10% off">
                                <input style={inputStyle()} type="number" placeholder="e.g. 10" min="0" max="99" value={discountPrice} onChange={e => setDiscPrice(e.target.value)} onFocus={focusGreen} onBlur={blurBorder()} />
                            </Field>
                            {discount && (
                        ...
                        <div style={{ ...cardStyle({ marginBottom: 0 }), padding: 18 }}>
                            ...
                            {[
                                ...
                                ['Discount', discount ? <span style={{ color: B.emerald.text, fontWeight: 800 }}>{discount}% off</span> : <span style={{ color: B.navyGhost }}>—</span>],
                                ['Final Price', (price && discount) ? <span style={{ color: B.emerald.text, fontWeight: 800 }}>${(+price - (+price * discount) / 100).toFixed(2)}</span> : <span style={{ color: B.navyGhost }}>—</span>],
