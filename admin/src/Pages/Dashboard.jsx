...
//   const font = { xs: 11, sm: 12.5, md: 13.5 }[size];
//   const styles = {
//     primary: { bg: hov ? B.greenHover : B.green, color: '#FFFFFF', border: `1px solid ${hov ? B.greenHover : B.green}` },
//     ghost: { bg: hov ? B.bgHover : 'transparent', color: B.navySoft, border: `1px solid ${B.border}` },
//     danger: { bg: hov ? '#FECACA' : B.red.bg, color: B.red.text, border: `1px solid ${B.red.border}` },
//     outline: { bg: hov ? B.greenBg : 'transparent', color: B.green, border: `1px solid ${B.greenBorder}` },
//     surface: { bg: hov ? B.bgHover : B.surface, color: B.navySoft, border: `1px solid ${B.border}` },
//     champ: { bg: hov ? '#EFE2C0' : B.champBg, color: B.champText, border: `1px solid ${B.champBorder}` },
//   }[variant] || {};
//   return (
//     <button onClick={onClick} disabled={disabled} title={title}
//       onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
...
//   if (!active || !payload?.length) return null;
//   return (
//     <div style={{ ...S.card2, borderRadius: 10, padding: '10px 14px', fontSize: 12.5, boxShadow: '0 8px 30px rgba(28,43,58,0.12)', border: `1px solid ${B.greenBorder}` }}>
//       <p style={{ color: B.green, fontWeight: 700, marginBottom: 8 }}>{label}</p>
//       {payload.map((p, i) => (
//         <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
//           <div style={{ width: 8, height: 8, borderRadius: '50%', background: p.color }} />
...
//       onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
//       style={{
//         background: B.surface2, border: `1px solid ${hov ? B.greenBorder : B.border}`,
//         borderRadius: 14, padding: '14px 16px', transition: 'box-shadow .2s, border-color .2s',
//         boxShadow: hov ? '0 8px 28px rgba(26,122,74,0.12)' : '0 2px 8px rgba(28,43,58,0.05)',
//         display: 'flex', flexDirection: 'column',
//       }}
//     >
//       <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
//         <div style={{ width: 36, height: 36, borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', background: B.greenBg, border: `1px solid ${B.greenBorder}` }}>
//           {React.cloneElement(icon, { size: 17, style: { color: B.green } })}
//         </div>
//         <span style={{ display: 'inline-flex', alignItems: 'center', gap: 3, fontSize: 11, fontWeight: 700, padding: '3px 8px', borderRadius: 99, background: isPos ? B.emerald.bg : B.red.bg, color: isPos ? B.emerald.text : B.red.text, border: `1px solid ${isPos ? B.emerald.border : B.red.border}` }}>
//           {isPos ? <TbTrendingUp size={11} /> : <TbTrendingDown size={11} />}
//           {Math.abs(change)}%
//         </span>
//       </div>
//       <p style={{ color: B.navyGhost, fontSize: 11, fontWeight: 600, letterSpacing: 0.3, marginBottom: 3 }}>{label}</p>
//       <p style={{ color: B.navy, fontSize: 20, fontWeight: 800, letterSpacing: -0.5, lineHeight: 1, marginBottom: 3 }}>{value}</p>
//       <p style={{ color: B.navyGhost, fontSize: 10.5, lineHeight: 1.4 }}>{changeLabel}</p>
...
//               </linearGradient>
//             </defs>
//             <Area type="monotone" dataKey="v" stroke={B.green} strokeWidth={1.8} fill={`url(#spark-${label})`} dot={false} />
//           </AreaChart>
//         </ResponsiveContainer>
//       </div>
//     </div>
...
// const MiniStat = ({ icon, label, value, trend, accentBg, accentColor, accentBorder }) => (
//   <div style={{ background: B.surface2, border: `1px solid ${B.border}`, borderRadius: 12, padding: '11px 14px', display: 'flex', alignItems: 'center', gap: 10, boxShadow: '0 1px 4px rgba(28,43,58,0.04)' }}>
//     <div style={{ width: 32, height: 32, borderRadius: 9, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: accentBg, border: `1px solid ${accentBorder || B.border}` }}>
//       {React.cloneElement(icon, { size: 14, style: { color: accentColor } })}
//     </div>
//     <div style={{ flex: 1, minWidth: 0 }}>
//       <p style={{ color: B.navyGhost, fontSize: 9.5, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 1 }}>{label}</p>
//       <p style={{ color: B.navy, fontSize: 16, fontWeight: 800, lineHeight: 1 }}>{value}</p>
//     </div>
//     {trend !== undefined && (
//       <span style={{ display: 'flex', alignItems: 'center', gap: 2, fontSize: 10, fontWeight: 700, color: trend >= 0 ? B.emerald.text : B.red.text, background: trend >= 0 ? B.emerald.bg : B.red.bg, padding: '2px 5px', borderRadius: 99, border: `1px solid ${trend >= 0 ? B.emerald.border : B.red.border}`, flexShrink: 0 }}>
//         {trend >= 0 ? <TbTrendingUp size={10} /> : <TbTrendingDown size={10} />}
//         {Math.abs(trend)}%
//       </span>
//     )}
//   </div>
...
// const SectionCard = ({ title, subtitle, children, toolbar, style = {} }) => (
//   <div style={{ background: B.surface2, border: `1px solid ${B.border}`, borderRadius: 16, overflow: 'hidden', boxShadow: '0 2px 8px rgba(28,43,58,0.05)', ...style }}>
//     <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', padding: '14px 18px', borderBottom: `1px solid ${B.border}`, background: B.surface, flexWrap: 'wrap', gap: 8 }}>
//       <div>
//         <h2 style={{ color: B.navy, fontSize: 13.5, fontWeight: 700 }}>{title}</h2>
//         {subtitle && <p style={{ color: B.navyGhost, fontSize: 11, marginTop: 2 }}>{subtitle}</p>}
//       </div>
...
//   return (
//     <div style={{ background: B.surface2, border: `1px solid ${B.border}`, borderRadius: 16, overflow: 'hidden', boxShadow: '0 2px 8px rgba(28,43,58,0.05)' }}>
//       <div style={{ padding: '14px 18px', borderBottom: `1px solid ${B.border}`, background: B.surface }}>
//         <h2 style={{ color: B.navy, fontSize: 13.5, fontWeight: 700 }}>Activity Feed</h2>
//         <p style={{ color: B.navyGhost, fontSize: 11, marginTop: 2 }}>Live store events</p>
//       </div>
...
//               onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
//             >
//               <div style={{ width: 28, height: 28, borderRadius: 8, flexShrink: 0, marginTop: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', background: a.c.bg, color: a.c.text, border: `1px solid ${a.c.border}` }}>{a.icon}</div>
//               <div style={{ flex: 1, minWidth: 0 }}>
//                 <p style={{ color: B.navy, fontSize: 12, fontWeight: 500, lineHeight: 1.4, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{a.text}</p>
//                 <p style={{ color: B.navyGhost, fontSize: 10.5, marginTop: 2, display: 'flex', alignItems: 'center', gap: 3 }}>
//                   <TbClock size={9} />{fmtRel(a.time)}
...
//         .db-tabs { -ms-overflow-style: none; scrollbar-width: none; }
//       `}</style>

//       {/* ══ HEADER BANNER ══ */}
//       <div style={{
//         background: B.surface2, borderBottom: `1px solid ${B.border}`,
...
//           {/* Date/time row */}
//           <p style={{ color: B.navyGhost, fontSize: 11, fontWeight: 500, marginBottom: 6, display: 'flex', alignItems: 'center', gap: 5, flexWrap: 'wrap' }}>
//             <TbCalendar size={11} style={{ color: B.green }} />
//             {liveTime.toLocaleDateString('en-US', { weekday: isMobile ? 'short' : 'long', year: 'numeric', month: isMobile ? 'short' : 'long', day: 'numeric' })}
//             &nbsp;·&nbsp;
//             <TbClock size={11} style={{ color: B.green }} />
//             {liveTime.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
//           </p>
...
//           <div style={{ display: 'flex', alignItems: isMobile ? 'flex-start' : 'center', justifyContent: 'space-between', flexDirection: isMobile ? 'column' : 'row', gap: isMobile ? 14 : 12 }}>

//             {/* Left — greeting */}
//             <div>
//               <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
//                 <div style={{ width: 28, height: 28, borderRadius: 7, background: B.green, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 3px 10px rgba(26,122,74,0.25)', flexShrink: 0 }}>
//                   <span style={{ fontWeight: 900, fontSize: 12, color: '#FFFFFF', fontFamily: 'Georgia, serif' }}>D</span>
//                 </div>
//                 <h1 style={{ fontSize: isMobile ? 18 : 20, fontWeight: 800, letterSpacing: -0.3, color: B.navy }}>
//                   {greeting}, Admin 👋
//                 </h1>
//               </div>
//               <p style={{ color: B.navySoft, fontSize: isMobile ? 11.5 : 12.5 }}>
//                 {loading ? 'Loading store data…' : `${kpi.totalOrders} orders · $${kpi.totalRev.toLocaleString('en-US')} GMV · $${kpi.paidRev.toLocaleString('en-US')} collected`}
//               </p>
//             </div>

//             {/* Right — today card + action buttons */}
//             <div style={{ display: 'flex', alignItems: 'center', gap: 10, width: isMobile ? '100%' : 'auto' }}>
//               {/* Today's Revenue card */}
//               <div style={{ background: B.greenBg, border: `1px solid ${B.greenBorder}`, borderRadius: 12, padding: '10px 16px', flex: isMobile ? 1 : 'none', minWidth: isMobile ? 0 : 140, boxShadow: '0 2px 10px rgba(26,122,74,0.08)' }}>
//                 <p style={{ color: B.navyGhost, fontSize: 9.5, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 0.7, marginBottom: 3 }}>Today's Revenue</p>
//                 <p style={{ color: B.green, fontSize: 18, fontWeight: 800, letterSpacing: -0.5, lineHeight: 1 }}>
//                   {loading ? '…' : `$${kpi.todayRev.toLocaleString('en-US')}`}
//                 </p>
//                 <p style={{ color: B.navyGhost, fontSize: 10, marginTop: 3 }}>{kpi.todayOrders} order{kpi.todayOrders !== 1 ? 's' : ''} today</p>
//               </div>

//               {/* Action buttons */}
//               <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
//                 <PrimaryBtn variant="primary" onClick={() => context.setIsOpenFullScreenPanel({ open: true, modal: 'Add product' })}>
//                   <TbPlus size={13} /> {isMobile ? 'Add' : 'Add Product'}
//                 </PrimaryBtn>
//                 <PrimaryBtn variant="surface" onClick={refreshAll} disabled={loading}>
//                   <TbRefresh size={13} style={{ animation: loading ? 'spin 1s linear infinite' : undefined }} />
//                   {isMobile ? '' : 'Refresh'}
//                 </PrimaryBtn>
//               </div>
//             </div>
...
//       <div style={{ maxWidth: 1400, margin: '0 auto', padding: isMobile ? '14px 12px 32px' : '20px 20px 40px' }}>

//         {/* ══ TABS ══ */}
//         <div className="db-tabs" style={{
//           display: 'flex', alignItems: 'center', gap: 3,
//           background: B.surface2, border: `1px solid ${B.border}`,
//           borderRadius: 12, padding: 4, marginBottom: 16,
//           overflowX: 'auto', boxShadow: '0 2px 8px rgba(28,43,58,0.05)',
//         }}>
//           {TABS.map(t => {
//             const active = activeTab === t.id;
//             return (
...
//                 borderRadius: 8, fontSize: isMobile ? 11.5 : 12.5, fontWeight: 600,
//                 whiteSpace: 'nowrap', cursor: 'pointer', transition: 'all .15s',
//                 border: active ? `1px solid ${B.greenBorder}` : '1px solid transparent',
//                 background: active ? B.greenBg : 'transparent',
//                 color: active ? B.green : B.navySoft,
//                 boxShadow: active ? '0 2px 8px rgba(26,122,74,0.12)' : 'none',
//                 flexShrink: 0,
...
//               >
//                 {t.icon}
//                 {/* hide label on very small mobile to save space */}
//                 {!(isMobile && window.innerWidth < 400) && <span style={{ marginLeft: 4 }}>{t.label}</span>}
//               </button>
//             );
//           })}
//         </div>
...
//             {/* 4 KPI cards — 2 cols on mobile, 4 on desktop */}
//             <div style={{
//               display: 'grid',
...
//             {/* 4 mini status pills — 2 cols on mobile, 4 on desktop */}
//             <div style={{
//               display: 'grid',
