...
//                         }}
//                     >
//                         This page has left our atelier
//                     </h1>

//                     {/* Body copy */}
//                     <p
//                         className="afu d4 text-[#8A7050] max-w-[400px] mb-10"
//                         style={{ fontSize: 12, letterSpacing: '0.05em', lineHeight: 1.95 }}
//                     >
//                         The page you seek may have been moved, retired, or never existed.
//                         <br />
//                         Our collection lives on — allow us to guide you back
//                         <br className="hidden sm:block" />
//                         to the craftsmanship you deserve.
//                     </p>
...
//                     {/* Quick nav */}
//                     <nav className="afi d6 flex flex-wrap justify-center gap-7 mt-10 pt-7 w-full max-w-xs border-t border-[#1C1408]">
//                         {[
//                             { label: 'Men', path: '/men' },
...
//                         style={{ fontSize: 8 }}
//                     >
//                         D Dolly Lamb &ensp;·&ensp; Artisan Atelier
//                     </span>
