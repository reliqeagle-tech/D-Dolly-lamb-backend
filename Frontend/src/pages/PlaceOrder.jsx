...
//   // const initPay = (order) => {
//   //   // ✅ window.Razorpay check karo pehle
//   //   if (!window.Razorpay) {
//   //     toast.error("Razorpay failed to load. Please refresh page.");
//   //     return;
//   //   }
...
//   //     },
//   //     prefill: {
//   //       name: formData.firstName + " " + formData.lastName,  // ✅ add karo
//   //       email: formData.email,
//   //       contact: formData.phone,
//   //     },
//   //     theme: {
//   //       color: "#c8973a"  // ✅ Gold theme D Dolly Lamb ke liye
//   //     }
//   //   };

//   //   const rzp = new window.Razorpay(options);
//   //   rzp.open();  // ✅ direct open, new se alag rakho
//   // };
...
//     console.log("Razorpay options:", options); // ✅ debug ke liye
...
//         console.log("Razorpay backend response:", r.data); // ✅ yeh add karo

//         if (r.data.success) {
//           initPay(r.data.order);
//         } else {
...
//       <div
//         className="min-h-screen py-6 px-5 sm:px-8 lg:px-16"
...
//           </p> */}
//           <h1
//             className="text-3xl sm:text-4xl font-light tracking-[0.08em] m-0"
//             style={{ color: "#f7c568" }}
//           >
//             SECURE CHECKOUT
//           </h1>
...
//                 }}>
//                   <p style={{
//                     fontSize: 10, color: "#c8973a",
//                     fontFamily: "Montserrat,sans-serif", letterSpacing: "0.15em"
//                   }}>
...
//                     }}
//                     style={{
//                       fontSize: 9, color: "#c8973a", background: "none",
//                       border: "1px solid rgba(200,151,58,0.3)",
...
//             {i < current
//               ? <IconCheck />
//               : <span className="text-[9px] font-bold" style={{ color: i === current ? "#c8973a" : "#3a2510" }}>{i + 1}</span>
//             }
//           </div>
//           <span
...
//             style={{ filter: active ? "brightness(1)" : "brightness(0.75)" }} />
//           : <span className="text-[11px] tracking-[0.16em] font-semibold"
//             style={{ color: active ? "#f7c568" : "#c8973a" }}>{label}</span>
//         }
//       </div>
//       {sublabel && (
//         <p className="text-[9px] italic mt-1.5 tracking-[0.1em]"
//           style={{ color: active ? "#c8973a" : "#8a7060" }}>{sublabel}</p>
//       )}
//     </div>
//   );
// };
...
//       <div
//         className="min-h-screen py-4 px-5 sm:px-8 lg:px-16"
//         style={{ background: "#1a0f0a", color: "#f5ede0", fontFamily: "Georgia,serif" }}
//       >

//         {/* ══ HEADER + STEPBAR — ek row mein ══ */}
//         <div className="max-w-6xl mx-auto mb-6 flex items-center justify-between flex-wrap gap-4">

//           {/* Left — Title */}
//           <div>
//             <h1
//               className="text-2xl sm:text-3xl font-light tracking-[0.1em] m-0"
//               style={{ color: "#f7c568" }}
//             >
//               SECURE CHECKOUT
//             </h1>
//             <div className="flex items-center gap-2 mt-1.5">
//               <span className="h-px w-14" style={{ background: "linear-gradient(to right,transparent,rgba(200,151,58,0.35))" }} />
//               <span className="w-1 h-1 rotate-45 flex-shrink-0" style={{ background: "#c8973a" }} />
//               <span className="h-px w-14" style={{ background: "linear-gradient(to left,transparent,rgba(200,151,58,0.35))" }} />
//             </div>
//           </div>
...
//               color: C.navyText, letterSpacing: "0.1em", margin: "0 0 6px",
//             }}>
//               SECURE <span style={{ color: C.indigo }}>CHECKOUT</span>
//             </h1>

//             {/* Decorative divider */}
//             <div style={{ display: "flex", alignItems: "center", gap: 12, justifyContent: "center", marginTop: 12, marginBottom: 18 }}>
