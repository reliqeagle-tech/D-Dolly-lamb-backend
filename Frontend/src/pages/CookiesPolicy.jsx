...
//     return (
//         <div>
//             <p className="text-[13.5px] text-slate-600 leading-[1.85] italic mb-5">
...
//                                     <p className="text-[11.5px] text-slate-500 italic leading-snug">{c.desc}</p>
//                                 </div>
//                             </div>
//                             <Toggle
//                                 checked={prefs[c.key]}
...
//                 <meta
//                     name="description"
//                     content="Learn how D Dolly Lamb uses cookies, what categories exist, and how to manage your preferences."
//                 />
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white via-[#F4F5FF] to-[#EEF0FF] font-['Montserrat',sans-serif]">
            <Helmet>
                ...
                <meta
                    property="og:title"
                    content="Cookie Policy | D Dolly Lamb"
                />

                <meta
                    property="og:description"
                    content="Learn how D Dolly Lamb uses cookies and how you can manage your cookie preferences."
                />

                <meta
                    property="og:url"
                    content="https://ddollylamb.com/cookies-policy"
                />
