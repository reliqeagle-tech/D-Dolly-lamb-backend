    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white via-[#F4F5FF] to-[#EEF0FF] font-['Montserrat',sans-serif]">
            <Helmet>
                ...
                <meta name="description" content="Learn how D Dolly Lamb collects, uses and protects your personal information when you shop for premium lambskin leather products." />
                ...
                <meta property="og:description" content="Learn how D Dolly Lamb collects, uses and protects your personal information." />
                <meta property="og:url" content="https://ddollylamb.com/privacy-policy" />
                <meta property="og:image" content="https://ddollylamb.com/DDL_logo4.png" />

                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Privacy Policy | D Dolly Lamb" />
                <meta name="twitter:description" content="Learn how D Dolly Lamb collects, uses and protects your personal information." />
