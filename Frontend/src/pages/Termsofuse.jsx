...
//             <>
//                 <p className="mb-3">
//                     We describe our leather jackets, pillow covers, recliner slipcovers,
//                     aprons and desk pads as accurately as possible.
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white via-[#F4F5FF] to-[#EEF0FF] font-['Montserrat',sans-serif]">
            <Helmet>
                ...
                <meta
                    property="og:url"
                    content="https://ddollylamb.com/terms-of-service"
                />
                <meta
                    property="og:image"
