...
//         if (!product?.category || !product?.subCategory || !product?.sku) {
...
//             <Link to={getProductUrl(product)} onClick={() => window.scrollTo(0, 0)}>
//                 <div style={{
...
const C = {
    ...
    borderLo: "rgba(99,102,241,0.14)",
    borderMid: "rgba(99,102,241,0.20)",
    gold: "#C8924A",   /* brand diamond only */
};
...
const STYLES = `
  ...
  /* ── Media zone — the photo block, visually separated from the info block ── */
  .wl-card-media {
    position: relative;
    background: #FFFFFF;
...
const Wishlist = () => {
    ...
    const GridCard = ({ product, idx }) => (
        <div className="wl-card" style={{ animationDelay: `${idx * 0.055}s` }}>
            ...
            {/* ── Media zone: padded + gradient bg + bottom divider, so it reads as its own block ── */}
            <Link to={getProductUrl(product)} onClick={() => window.scrollTo(0, 0)}>
            ...
            {/* ── Info zone: tinted so it doesn't read as flat white, same 16px inset as media zone ── */}
            <div style={{
                padding: "14px 16px 18px", display: "flex", flexDirection: "column", gap: 8, flex: 1,
                background: "linear-gradient(180deg, rgba(99,102,241,0.14) 0%, rgba(99,102,241,0.26) 100%)",
            }}>
                <p style={{
                    fontSize: 7.5, color: C.indigoDk, letterSpacing: "0.2em",
                    fontFamily: "Montserrat,sans-serif", fontWeight: 700, margin: 0,
                    textTransform: "uppercase", display: "inline-flex", alignSelf: "flex-start",
                    background: "rgba(99,102,241,0.12)", padding: "3px 9px", borderRadius: 20,
                }}>
                    LAMBSKIN
                </p>
                <Link to={getProductUrl(product)} onClick={() => window.scrollTo(0, 0)}
        ...
        <div className="wl-list-card" style={{ animationDelay: `${idx * 0.055}s` }}>
            ...
            <div style={{
                ...
                <div style={{ flex: 1, minWidth: 180 }}>
                    <p style={{
                        fontSize: 7.5, color: C.indigoDk, letterSpacing: "0.2em",
                        fontFamily: "Montserrat,sans-serif", fontWeight: 700, marginBottom: 8,
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            {sorted.length === 0 ? (
                                ...
                                <div style={{
                                    background: "#FFFFFF",
                                    border: "1px solid rgba(99,102,241,0.20)", borderRadius: 12,
                                    padding: "72px 24px", textAlign: "center",
