...
// const IconCheck = () => (<svg width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M5 12l5 5L20 7" stroke="#1a0f0a" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" /></svg>)

// /* ── Filter Tag ── */
// const FilterTag = ({ label, onRemove }) => (
//   <div className="flex items-center gap-1.5 px-2.5 py-1 cursor-pointer" onClick={onRemove}
//     style={{ border: "1px solid rgba(200,151,58,0.35)", borderRadius: "2px", background: "rgba(200,151,58,0.06)" }}>
//     <span style={{ fontSize: "9px", color: "#c8973a", letterSpacing: "0.12em", fontFamily: "Georgia,serif" }}>{label}</span>
//     <span style={{ color: "#c8973a", opacity: 0.7 }}><IconClose /></span>
//   </div>
// )
...
//   return (
//     <div style={{ borderBottom: "1px solid rgba(200,151,58,0.1)" }}>
//       <button onClick={() => setOpen(!open)} className="w-full flex items-center justify-between py-3.5 bg-transparent border-none cursor-pointer" style={{ color: "#f5ede0" }}>
//         <span style={{ fontSize: "9px", letterSpacing: "0.3em", fontFamily: "Georgia,serif", fontWeight: 600, color: "#c8973a", textTransform: "uppercase" }}>{title}</span>
//         <IconChevron open={open} />
//       </button>
...
//    Each category row = checkbox + label + arrow
//    Arrow expands subcategory list below it
// ══════════════════════════════════════════════ */
...
//     <div style={{
//       marginBottom: "3px",
//       border: catChecked ? "1px solid rgba(200,151,58,0.3)" : "1px solid rgba(200,151,58,0.07)",
//       borderRadius: "5px",
//       background: catChecked ? "rgba(200,151,58,0.03)" : "transparent",
//       overflow: "hidden",
...
//         {/* Checkbox — toggles category filter */}
//         <div
//           onClick={() => onCatToggle({ target: { value: cat } })}
//           style={{
//             width: "15px", height: "15px", flexShrink: 0,
//             border: `1px solid ${catChecked ? "#c8973a" : "rgba(200,151,58,0.25)"}`,
//             background: catChecked ? "linear-gradient(135deg,#c8973a,#f7c568)" : "transparent",
//             borderRadius: "2px",
//             display: "flex", alignItems: "center", justifyContent: "center",
...
//         {/* Label + count + arrow — clicking label selects category AND opens/closes subs */}
//         <button
//           onClick={() => {
//             if (!catChecked) {
//               onCatToggle({ target: { value: cat } })
//               setSubOpen(true)
//             } else {
//               setSubOpen(p => !p)
//             }
...
//         >
//           <span style={{
//             fontSize: "11px", fontFamily: "Georgia,serif", letterSpacing: "0.04em",
//             color: catChecked ? "#f7c568" : "#a08060",
...
//             {/* Product count */}
//             {catCount !== undefined && (
//               <span style={{ fontSize: "9px", color: "#4a3020", fontFamily: "Georgia,serif" }}>({catCount})</span>
//             )}
//             {/* Selected sub-count badge */}
//             {checkedSubCount > 0 && (
//               <span style={{
//                 fontSize: "8px", fontWeight: 700,
//                 background: "linear-gradient(135deg,#c8973a,#f7c568)",
//                 color: "#1a0f0a", borderRadius: "99px",
//                 padding: "1px 5px",
//               }}>
//                 {checkedSubCount}
//               </span>
//             )}
//             {/* Expand/collapse arrow — only if has subcategories */}
//             {subList.length > 0 && (
//               <span style={{
//                 color: catChecked ? "#c8973a" : "#5a4030",
...
//         }}>
//           <div style={{ borderTop: "1px solid rgba(200,151,58,0.1)", background: "rgba(0,0,0,0.2)" }}>
//             {subList.map((sub, idx) => {
...
//                     background: isChecked ? "rgba(200,151,58,0.12)" : "transparent",
//                     border: "none", cursor: "pointer", textAlign: "left",
//                     borderBottom: idx < subList.length - 1 ? "1px solid rgba(200,151,58,0.05)" : "none",
//                   }}
//                   onMouseEnter={e => { if (!isChecked) e.currentTarget.style.background = "rgba(200,151,58,0.05)" }}
//                   onMouseLeave={e => { if (!isChecked) e.currentTarget.style.background = "transparent" }}
//                 >
//                   {/* Round radio-style indicator */}
//                   <div style={{
//                     width: "13px", height: "13px", flexShrink: 0,
//                     border: `1.5px solid ${isChecked ? "#c8973a" : "rgba(200,151,58,0.2)"}`,
//                     borderRadius: "50%",
//                     background: isChecked ? "linear-gradient(135deg,#c8973a,#f7c568)" : "transparent",
//                     display: "flex", alignItems: "center", justifyContent: "center",
//                     transition: "all 0.2s",
//                   }}>
//                     {isChecked && (
//                       <svg width="7" height="7" viewBox="0 0 24 24" fill="none">
//                         <path d="M5 12l5 5L20 7" stroke="#1a0f0a" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
//                       </svg>
//                     )}
//                   </div>

//                   {/* Gold accent bar on selected */}
//                   {isChecked && <div style={{ width: "2px", height: "11px", background: "#c8973a", borderRadius: "1px", flexShrink: 0 }} />}

//                   <span style={{
//                     fontSize: "10.5px", fontFamily: "Georgia,serif", letterSpacing: "0.03em",
//                     color: isChecked ? "#f7c568" : "#7a5a3a",
...
//       <div className="w-full max-w-xs">
//         <div className="flex justify-between mb-2">
//           <span style={{ fontSize: "9px", color: "#7a6050", letterSpacing: "0.2em", fontFamily: "Georgia,serif" }}>{shown} OF {total} PIECES</span>
//           <span style={{ fontSize: "9px", color: "#c8973a", letterSpacing: "0.1em", fontFamily: "Georgia,serif" }}>{pct}%</span>
//         </div>
//         <div className="w-full h-px" style={{ background: "rgba(200,151,58,0.12)", position: "relative", borderRadius: "2px" }}>
//           <div style={{ position: "absolute", top: 0, left: 0, height: "100%", width: `${pct}%`, background: "linear-gradient(to right,#c8973a,#f7c568)", borderRadius: "2px", transition: "width 0.6s ease", boxShadow: "0 0 8px rgba(200,151,58,0.5)" }} />
//         </div>
//       </div>
//       <button onClick={onLoadMore} disabled={loading}
//         style={{ padding: "13px 48px", border: "1px solid rgba(200,151,58,0.4)", borderRadius: "2px", background: loading ? "rgba(200,151,58,0.06)" : "transparent", color: "#c8973a", fontSize: "10px", letterSpacing: "0.28em", fontFamily: "Georgia,serif", cursor: loading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "10px", transition: "all 0.25s" }}
//         onMouseEnter={e => { if (!loading) { e.currentTarget.style.background = "rgba(200,151,58,0.1)"; e.currentTarget.style.borderColor = "#c8973a"; e.currentTarget.style.color = "#f7c568" } }}
//         onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "rgba(200,151,58,0.4)"; e.currentTarget.style.color = "#c8973a" }}>
//         {loading ? (<><svg width="14" height="14" viewBox="0 0 24 24" fill="none" style={{ animation: "spin 0.8s linear infinite" }}><circle cx="12" cy="12" r="9" stroke="rgba(200,151,58,0.3)" strokeWidth="2" /><path d="M12 3a9 9 0 0 1 9 9" stroke="#c8973a" strokeWidth="2" strokeLinecap="round" /></svg>LOADING...</>) : (<>LOAD MORE<svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M12 5v14M5 12l7 7 7-7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></>)}
//       </button>
//       <span style={{ fontSize: "9px", color: "#3d2010", letterSpacing: "0.15em", fontFamily: "Georgia,serif" }}>{total - shown} MORE PIECES TO EXPLORE</span>
//     </div>
//   )
// }
...
//   const subCategoriesMap = {
//     Men: ["Biker Jacket", "Bomber Biker Jacket", "Moto Biker Jacket"],
//     Women: ["Bomber Biker Jacket", "Moto Biker Jacket", "Racing Coat", "Women Winter Wear", "Women Night Dress", "Leather Pencil Skirt", "Leather Full Skirt", "Slim Bodycon Skirt"],
//     Others: ["Cushion Cover", "Aprons", "Desk Mat", "Pillow", "Chair Cover"],
...
//           style={{ width: "100%", padding: "9px 36px 9px 12px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(200,151,58,0.18)", borderRadius: "2px", color: "#f5ede0", fontSize: "11px", fontFamily: "Montserrat,serif", outline: "none", transition: "border-color 0.2s" }}
//           onFocus={e => e.target.style.borderColor = "#c8973a"}
//           onBlur={e => e.target.style.borderColor = "rgba(200,151,58,0.18)"} />
//         <span className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: "#5a4030" }}><IconSearch /></span>
//       </div>
...
//           ))}
//         </div>
//         <p style={{ fontSize: "9px", color: "#3a2510", letterSpacing: "0.06em", fontFamily: "Georgia,serif", marginTop: "10px", fontStyle: "italic" }}>
...
//             <span style={{ fontSize: "10px", color: "#c8973a", fontFamily: "Georgia,serif" }}>${priceRange[1]}</span>
//           </div>
//           <input type="range" min={0} max={maxPrice} value={priceRange[1]} onChange={e => setPriceRange([priceRange[0], Number(e.target.value)])} className="price-slider" />
//           <div className="flex gap-2 mt-3">
//             <input type="number" value={priceRange[0]} min={0} max={priceRange[1]} onChange={e => setPriceRange([Number(e.target.value), priceRange[1]])} style={{ width: "50%", padding: "5px 8px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(200,151,58,0.18)", borderRadius: "2px", color: "#f5ede0", fontSize: "11px", outline: "none" }} />
//             <input type="number" value={priceRange[1]} min={priceRange[0]} max={maxPrice} onChange={e => setPriceRange([priceRange[0], Number(e.target.value)])} style={{ width: "50%", padding: "5px 8px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(200,151,58,0.18)", borderRadius: "2px", color: "#f5ede0", fontSize: "11px", outline: "none" }} />
//           </div>
//         </div>
//       </FilterSection>
...
//           <button key={label} onClick={toggle} className="w-full flex items-center gap-2.5 py-2 px-1 transition-all" style={{ background: "none", border: "none", cursor: "pointer", textAlign: "left" }}>
//             <div style={{ width: "15px", height: "15px", flexShrink: 0, border: `1px solid ${checked ? "#c8973a" : "rgba(200,151,58,0.25)"}`, background: checked ? "linear-gradient(135deg,#c8973a,#f7c568)" : "transparent", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.2s" }}>
//               {checked && <IconCheck />}
//             </div>
//             <span style={{ fontSize: "11px", color: checked ? "#f7c568" : "#a08060", fontFamily: "Georgia,serif", letterSpacing: "0.04em" }}>{label}</span>
//           </button>
//         ))}
//       </FilterSection>
//     </>
...
//         .price-slider{-webkit-appearance:none;appearance:none;width:100%;height:2px;background:linear-gradient(to right,#c8973a,#f7c568);outline:none;border-radius:2px}
//         .price-slider::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;width:14px;height:14px;border-radius:50%;background:linear-gradient(135deg,#c8973a,#f7c568);cursor:pointer;border:2px solid #1a0f0a;box-shadow:0 0 6px rgba(200,151,58,0.5)}
//         .sort-select{background:rgba(255,255,255,0.03);border:1px solid rgba(200,151,58,0.2);color:#f5ede0;font-family:Georgia,serif;font-size:12px;letter-spacing:0.06em;padding:9px 32px 9px 14px;border-radius:2px;outline:none;cursor:pointer;appearance:none;transition:border-color 0.2s}
//         .sort-select:focus{border-color:#c8973a}.sort-select option{background:#1a0f0a;color:#f5ede0}
//         .view-btn{width:34px;height:34px;display:flex;align-items:center;justify-content:center;border:1px solid rgba(200,151,58,0.18);border-radius:2px;cursor:pointer;background:transparent;transition:all 0.2s}
//         .view-btn.active,.view-btn:hover{border-color:#c8973a;background:rgba(200,151,58,0.1);color:#f7c568}
//         .mobile-overlay{position:fixed;inset:0;z-index:999;background:rgba(0,0,0,0.7);backdrop-filter:blur(4px)}
//         .mobile-drawer{position:fixed;top:68px;left:0;bottom:0;width:min(340px,90vw);z-index:1000;background:#120a05;border-right:1px solid rgba(200,151,58,0.2);overflow-y:auto;animation:drawerIn 0.3s cubic-bezier(0.16,1,0.3,1)}
...
//           All <span style={{ color: "#f5ede0" }}>Collections</span>
//         </h1>
//         <p style={{ fontSize: "13px", color: "#5a4030", fontStyle: "italic", fontFamily: "Georgia,serif" }}>{filterProducts.length} pieces found</p>
//       </div>

//       <div className="flex">
//         {/* ── DESKTOP SIDEBAR ── */}
//         <aside className="hidden lg:block w-72 flex-shrink-0 sticky top-[68px] self-start h-[calc(100vh-68px)] overflow-y-auto px-5 py-6" style={{ borderRight: "1px solid rgba(200,151,58,0.1)" }}>
//           <div className="flex items-center justify-between mb-5">
//             <div className="flex items-center gap-2" style={{ color: "#c8973a" }}>
//               <IconFilter />
//               <span style={{ fontSize: "10px", letterSpacing: "0.3em", fontFamily: "Georgia,serif", fontWeight: 600 }}>FILTERS</span>
//               {activeFilterCount > 0 && (
//                 <span className="flex items-center justify-center w-4 h-4 rounded-full text-[8px] font-bold" style={{ background: "linear-gradient(135deg,#c8973a,#f7c568)", color: "#1a0f0a" }}>{activeFilterCount}</span>
//               )}
//             </div>
//             {activeFilterCount > 0 && (
//               <button onClick={clearAllFilters} style={{ fontSize: "9px", color: "#5a4030", letterSpacing: "0.15em", fontFamily: "Georgia,serif", background: "none", border: "none", cursor: "pointer" }}
//                 onMouseEnter={e => e.target.style.color = "#c8973a"} onMouseLeave={e => e.target.style.color = "#5a4030"}>
//                 CLEAR ALL
//               </button>
//             )}
//           </div>
...
//               <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: "1px solid rgba(200,151,58,0.15)" }}>
//                 <span style={{ fontSize: "10px", letterSpacing: "0.3em", color: "#c8973a", fontFamily: "Georgia,serif" }}>FILTERS</span>
//                 <button onClick={() => setShowFilter(false)} style={{ background: "none", border: "none", color: "#c8973a", cursor: "pointer" }}><IconClose /></button>
//               </div>
//               <div className="px-5 py-4">
//                 <SidebarContent />
//                 {activeFilterCount > 0 && (
//                   <button onClick={() => { clearAllFilters(); setShowFilter(false) }} className="w-full mt-5 py-2.5 text-center"
//                     style={{ border: "1px solid rgba(200,151,58,0.3)", color: "#c8973a", fontSize: "10px", letterSpacing: "0.2em", fontFamily: "Georgia,serif", background: "none", cursor: "pointer", borderRadius: "2px" }}>
//                     CLEAR ALL FILTERS
//                   </button>
//                 )}
...
//         <main className="flex-1 px-2 sm:px-6 py-6">
//           {/* Toolbar */}
//           <div className="flex flex-wrap items-center justify-between gap-3 mb-6 pb-5" style={{ borderBottom: "1px solid rgba(200,151,58,0.1)" }}>
//             <div className="flex items-center gap-3 flex-wrap">
//               <button className="lg:hidden flex items-center gap-2 px-3 py-2" onClick={() => setShowFilter(true)}
//                 style={{ border: "1px solid rgba(200,151,58,0.25)", color: "#c8973a", background: "transparent", borderRadius: "2px", fontSize: "10px", letterSpacing: "0.18em", fontFamily: "Georgia,serif", cursor: "pointer" }}>
//                 <IconFilter /> FILTER
//                 {activeFilterCount > 0 && <span style={{ background: "linear-gradient(135deg,#c8973a,#f7c568)", color: "#1a0f0a", borderRadius: "50%", width: 16, height: 16, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 8, fontWeight: 700 }}>{activeFilterCount}</span>}
//               </button>
...
//                     <option value="high-low">Price: High → Low</option>
//                   </select>
//                   <span className="absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: "#c8973a" }}><IconChevron open={false} /></span>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//           ) : (
//             <div className="empty-state flex flex-col items-center justify-center py-24 gap-5">
//               <svg width="48" height="48" viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="22" stroke="rgba(200,151,58,0.2)" strokeWidth="1.5" /><path d="M16 24l5 5 11-10" stroke="rgba(200,151,58,0.3)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
//               <p style={{ fontSize: "13px", color: "#5a4030", fontStyle: "italic", fontFamily: "Georgia,serif" }}>No pieces match your current filters</p>
//               <button onClick={clearAllFilters} className="px-6 py-2.5"
//                 style={{ border: "1px solid rgba(200,151,58,0.3)", color: "#c8973a", fontSize: "10px", letterSpacing: "0.2em", fontFamily: "Georgia,serif", background: "none", cursor: "pointer", borderRadius: "2px", transition: "all 0.2s" }}
//                 onMouseEnter={e => { e.target.style.background = "rgba(200,151,58,0.08)"; e.target.style.borderColor = "#c8973a" }}
//                 onMouseLeave={e => { e.target.style.background = "none"; e.target.style.borderColor = "rgba(200,151,58,0.3)" }}>
//                 CLEAR FILTERS
...
//   // ✅ Must exactly match Add.jsx subcategory options — same values, same spelling
//   const subCategoriesMap = {
...
//   /* ── Shared sidebar content ── render function not component to avoid remount ── */
//   const renderSidebar = () => (
//     <>
//       {/* Search */}
//       <div className="relative mb-4">
...
//               outline: "none",
//               cursor: "pointer",
//               background: `linear-gradient(to right, #c8973a ${Math.round((priceRange[1] / maxPrice) * 100)}%, rgba(200,151,58,0.15) ${Math.round((priceRange[1] / maxPrice) * 100)}%)`,
//             }}
//           />
//           <div className="flex gap-2 mt-3">
//             <input type="number" value={priceRange[0]} min={0} max={priceRange[1]} onChange={e => setPriceRange([Number(e.target.value), priceRange[1]])} style={{ width: "50%", padding: "5px 8px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(200,151,58,0.18)", borderRadius: "2px", color: "#f5ede0", fontSize: "11px", outline: "none" }} />
...
//         .col-card:nth-child(5){animation-delay:0.20s}.col-card:nth-child(6){animation-delay:0.24s}
//         .col-card:nth-child(7){animation-delay:0.28s}.col-card:nth-child(8){animation-delay:0.32s}
//         input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;width:14px;height:14px;border-radius:50%;background:linear-gradient(135deg,#c8973a,#f7c568);cursor:pointer;border:2px solid #1a0f0a;box-shadow:0 0 6px rgba(200,151,58,0.5)}
//         input[type=range]::-moz-range-thumb{width:16px;height:16px;border-radius:50%;background:linear-gradient(135deg,#c8973a,#f7c568);cursor:pointer;border:2px solid #1a0f0a;box-shadow:0 0 6px rgba(200,151,58,0.5)}
//         .sort-select{background:rgba(255,255,255,0.03);border:1px solid rgba(200,151,58,0.2);color:#f5ede0;font-family:Georgia,serif;font-size:12px;letter-spacing:0.06em;padding:9px 32px 9px 14px;border-radius:2px;outline:none;cursor:pointer;appearance:none;transition:border-color 0.2s}
//         .sort-select:focus{border-color:#c8973a}.sort-select option{background:#1a0f0a;color:#f5ede0}
//         .view-btn{width:34px;height:34px;display:flex;align-items:center;justify-content:center;border:1px solid rgba(200,151,58,0.18);border-radius:2px;cursor:pointer;background:transparent;transition:all 0.2s}
//         .view-btn.active,.view-btn:hover{border-color:#c8973a;background:rgba(200,151,58,0.1);color:#f7c568}
...
//         <div className="flex items-center gap-2.5">
//           <span style={{ fontSize: "9px", letterSpacing: "0.28em", color: "#7a5030", fontFamily: "Georgia,serif", textTransform: "uppercase" }}>D Dolly Lamb</span>
//           <span style={{ color: "rgba(200,151,58,0.2)", fontSize: "12px", lineHeight: 1 }}>/</span>
//           <h1 style={{ fontFamily: "Georgia,serif", fontSize: "clamp(1.1rem,1.6vw,1.35rem)", fontWeight: 600, color: "#f7c568", letterSpacing: "0.15em", margin: 0, textTransform: "uppercase" }}>
//             All Collections
//           </h1>
//         </div>
//         {/* Right — piece count */}
//         <div className="flex items-center gap-2.5">
//           <span style={{ display: "block", height: "1px", width: "40px", background: "linear-gradient(to right,transparent,rgba(200,151,58,0.3))" }} />
//           <span style={{ fontSize: "9px", color: "#8a6040", fontFamily: "Georgia,serif", letterSpacing: "0.22em" }}>
...
/*
  ...
  ═══════════════════════════════════════════════
  OLD dark brown:
    bg: #1a0f0a  dark brown
    sidebar: #120a05
    accent: #c8973a / #f7c568  amber
    text: #f5ede0 / #a08060 / #7a5030
    border: rgba(200,151,58,…)
    checkbox: amber gradient
    filter tags: amber
