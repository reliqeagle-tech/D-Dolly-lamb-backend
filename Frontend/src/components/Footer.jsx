...
// /*
//   ═══════════════════════════════════════════════
//   COLOR SYSTEM — D DOLLY LAMB FOOTER
//   Matched to Navbar palette:
//     Navbar bg:       #FFFFFF / rgba(255,255,255,0.97)
//     Nav text:        #1E1B4B  (deep navy-indigo)
//     Nav accent:      #5B5BD6  (indigo)
//     Nav light:       #818CF8  (indigo light)
//     Nav dark:        #4338CA  (indigo dark)
//     Logo gold:       #C8924A  (brand gold — kept)
//     Border:          rgba(91,91,214,0.15)

//   Footer strategy:
//     • Light base (#F8F7FF → #FFFFFF) — premium white, matches nav bg
//     • Deep section (#1E1B4B) — navy-indigo for contrast bottom bar
//     • Indigo accent system replaces old gold ramp
//     • Gold (#C8924A) kept ONLY for brand diamond icon (logo mark)
//     • All text, borders, accents → indigo family
//   ═══════════════════════════════════════════════
// */
...
//   /* Backgrounds */
//   bgLight: "#FFFFFF",
//   bgSoft: "#F8F7FF",          /* very subtle indigo tint — matches mega menu */
//   bgSection: "#F0EEFF",          /* section divider bg */
//   bgDeep: "#1E1B4B",          /* deep navy — bottom bar */
//   bgDeepMid: "#16133A",          /* slightly darker for gradient */

//   /* Indigo palette — primary accent system */
//   indigo: "#5B5BD6",          /* primary indigo */
//   indigoLt: "#818CF8",          /* light indigo — secondary accents */
//   indigoDk: "#4338CA",          /* dark indigo — CTA buttons */
//   indigoXDk: "#312E81",          /* very dark — deep text on light */

//   /* Text */
//   textNavy: "#1E1B4B",          /* primary headings on light bg */
//   textBody: "#4B5563",          /* body text — dark grey */
//   textMuted: "#6B7280",          /* muted links */
//   textFaint: "#9CA3AF",          /* placeholder / tertiary */
//   textLight: "#E8E6F8",          /* text on dark bg */
//   textLightMid: "#A5A3C8",          /* muted text on dark bg */
//   textLightDim: "#6B6890",          /* dim text on dark bg */

//   /* Borders */
//   borderHi: "rgba(91,91,214,0.20)",  /* visible border */
//   borderLo: "rgba(91,91,214,0.10)",  /* subtle divider */
//   borderDeep: "rgba(255,255,255,0.08)",/* border on dark bg */
...
//     <>
//       <span style={{
//         display: "block", width: 10, height: 1, flexShrink: 0,
//         background: C.indigo, opacity: 0.35,
//         transition: "width 0.25s ease, opacity 0.25s ease",
//       }} className="group-hover:!w-[16px] group-hover:!opacity-100" />
//       <span style={{
//         color: C.textMuted,
...
//       }}
//         className="group-hover:!text-[#5B5BD6] group-hover:translate-x-0.5">
//         {children}
//       </span>
//     </>
//   );
...
//         /* ── Animations — all preserved exactly ── */
//         @keyframes fadeUp {
//           from { opacity: 0; transform: translateY(14px); }
//           to   { opacity: 1; transform: translateY(0); }
//         }
...
//         /* Shimmer — now indigo to match navbar shimmer */
//         .ft-shimmer-bar {
//           background: linear-gradient(90deg,
//             transparent 0%,
...
//         /* Policy links hover on dark bar */
//         .ft-policy-link {
//           font-size: 9px;
...
//           transition: color 0.2s;
//         }
//         .ft-policy-link:hover { color: #818CF8; }
//       `}</style>

//       {/* ── TOP SHIMMER — indigo, matches navbar exactly ── */}
//       <div className="ft-shimmer-bar" style={{ height: "1.5px" }} />

//       {/* ── BRAND HERO ROW — light bg ── */}
//       <div style={{
//         textAlign: "center",
...
//             {/* Trust badges — indigo accents */}
//             <div style={{ marginTop: 32 }} className="space-y-3">
//               {trustBadges.map((b, i) => (
//                 <div key={i} style={{ display: "flex", alignItems: "center", gap: 8 }}>
//                   <span style={{ fontSize: 9, color: C.indigo, opacity: 0.7 }}>{b.icon}</span>
//                   <span style={{
...
//                 >
//                   {loading
//                     ? <span style={{ fontSize: 10, letterSpacing: "0.1em", color: "#fff" }}>...</span>
//                     : <IconArrow />
//                   }
//                 </button>
//               </form>
...
//       {/* ── BOTTOM BAR — deep navy (same as nav text color) ── */}
//       <div style={{
//         background: `linear-gradient(180deg, ${C.bgDeep} 0%, ${C.bgDeepMid} 100%)`,
//         borderTop: `1px solid ${C.borderHi}`,
//       }}>
...
//               <span key={i} style={{
//                 fontSize: 9, letterSpacing: "0.22em",
//                 color: "rgba(129,140,248,0.45)",    /* indigoLt at 45% opacity */
//                 fontFamily: "Montserrat, sans-serif",
//                 fontWeight: 500,
//               }}>{t}</span>
//             ))}
...
//         }}>
//           <p style={{
//             fontSize: 10, color: C.textLightDim,
//             letterSpacing: "0.14em",
//             fontFamily: "Montserrat, sans-serif",
//             fontWeight: 500,
//             margin: 0,
//           }}>
//             COPYRIGHT © 2025{" "}
//             <span style={{ color: C.indigoLt }}>DDOLLYLAMB.COM</span>
//             {" "}— ALL RIGHTS RESERVED
//           </p>
//           <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
//             {["Privacy Policy", "Terms of Use", "Cookies"].map((item, i) => (
...
//       {/* ── BOTTOM SHIMMER — bookend, matches top ── */}
//       <div className="ft-shimmer-bar" style={{ height: "1.5px" }} />
