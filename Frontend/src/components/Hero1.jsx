...
const COLLECTIONS = [
  {
    title: "MEN'S", subtitle: "Leather Jackets", tag: "NEW SEASON", desc: "Structured silhouettes with raw edge finishing", href: "/collection?category=Men's", accent: "#4F46E5", light: "#EEF2FF", mid: "#C7D2FE", image: assets.menPng, menWidth: "52%",
  },
  {
    title: "WOMEN'S", subtitle: "Leather Jackets", tag: "BESTSELLER", desc: "Tailored cuts with refined feminine details", href: "/collection?category=Women's", accent: "#7C3AED", light: "#F5F3FF", mid: "#DDD6FE", image: assets.womenPng, imgWidth: "62%", menWidth: "62%",
  },
  {
